...
>[!note]
>There is a bug in the deployed app where nginx fails to fetch the page for certain routes aside from the home route, particularly upon refresh. This is an issue I am currently trying to fix, but **it should not hinder the performance of the app** as long as the user doesn't refresh the app when it is in a route other than `http://13.237.169.162:3000/`. 
>
